...
function Waveform:display_waveform_frame()
  ...
  screen.level(1)
  -- screen.aa(1)
  screen.move(self.composition_left-padding,self.composition_top-padding)
  screen.rect(self.composition_left-padding,self.composition_top-padding,self.composition_right-self.composition_left+(padding*2),self.composition_bottom-self.composition_top+(padding*2))
  screen.stroke()
  -- screen.aa(0)
