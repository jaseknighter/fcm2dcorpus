  ...
  alloc {
    ...
    analyze={
      ...
      fork{
        ...
        FluidBufOnsetSlice.process(s,sliceBuf,numChans: 1,metric:0,threshold:sliceThresh,minSliceLength:min_slice_length,indices:indices,windowSize:1024,hopSize: 1024*2,action:{
